  ...
  return (
    <section ref={ref} className="relative min-h-screen w-full overflow-hidden flex items-center justify-center py-12 sm:py-16 md:py-0 pt-0 bg-old-lace">
      <motion.div style={{ y, scale }} className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-soft-charcoal/25 via-soft-charcoal/10 to-transparent" />
      </motion.div>
...
const ProjectOverviewSection = () => {
  ...
  return (
    <section ref={ref} className="py-20 sm:py-28 md:py-36 bg-warm-beige relative">
